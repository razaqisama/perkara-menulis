...
export const StoryPreview = () => {
    ...
    return (
        <div className="py-4 border-b-[1px] hover:bg-gray-800 transition duration-300 ease-in-out px-4 cursor-pointer">
            <img src={Logo} alt="Articles" className="w-24 px-2 float-left"></img>
            <div className="flex flex-row justify-between">
                <h1 className="text-2xl font-bold">Some nice title for your story</h1>
                <div className="flex flex-row items-center justify-end space-x-2 text-xs">
                    <div className="min-w-[24px] min-h-[24px] rounded-full bg-white"></div>
                    <p className="w-max">Writers Name</p>
                    <p>·</p>
                    <p>9/20/2022</p>
                </div>
            </div>
            ...
            <div className="flex flex-row justify-between py-2">
                ...
                <div className="flex flex-row space-x-2">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="hover:text-blue-600 w-6 h-6 transition duration-300 ease-in-out">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="hover:text-black hover:bg-white rounded-full w-6 h-6 transition duration-300 ease-in-out">
